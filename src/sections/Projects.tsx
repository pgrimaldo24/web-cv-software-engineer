  ...
  return (
    <Card className="flex flex-col">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        {extraStackCount > 0 && <Badge>+{extraStackCount} más</Badge>}
      </div>
      ...
      <button
        ...
        className="mt-4 flex items-center gap-1.5 text-sm font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400 dark:hover:text-indigo-300"
      >
